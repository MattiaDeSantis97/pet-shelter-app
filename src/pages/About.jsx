  ...
  return (
    <div className="max-w-4xl mx-auto mt-12 p-10 bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20">
      ...
      <div className="space-y-6 text-slate-700 text-lg leading-relaxed font-medium">
        ...
        <p>La nostra missione è semplice ma fondamentale: ridurre il randagismo e garantire a ogni cane, gatto o altro animale da compagnia una vita dignitosa e felice. Lavoriamo in stretta collaborazione con rifugi locali e partner esterni, unendo le forze per trovargli il compagno perfetto.</p>
        <p>Tramite il nostro portale puoi visualizzare in tempo reale gli animali disponibili e inviare richieste di adozione. Dietro le quinte, i nostri <strong>Volontari</strong> aggiornano costantemente le schede e le foto, mentre il team <strong>Admin</strong> si assicura che ogni adozione vada a buon fine con serietà e sicurezza.</p>
